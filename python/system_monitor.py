...
def get_statistics():
    ...
    """
    # Load average
    # This is the average system load calculated over
    # a given period of time of 1, 5 and 15 minutes.
    ...
    # Network latency
    """
    Here we will ping google at an interval of five seconds
    for five times and record the
...
# Here we can send the statistics to a server or even
# locally store the statistics in a database.
